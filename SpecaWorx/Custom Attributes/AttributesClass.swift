...
class customCellViewClass: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass1: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass2: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass3: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass4: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass5: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customCellViewClass6: UIView{
    init() {
        super.init(frame: .zero)
        self.translatesAutoresizingMaskIntoConstraints = false
...
class customTextFieldClass1: UITextField {
...
class customTextFieldClass2: UITextField {
...
class customTextFieldClass3: UITextField {
...
class customTextFieldClass4: UITextField {
...
class customTextFieldClass5: UITextField {
